        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{ route('atualizar_cargo') }}">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <select id="area" type="text" class="form-control " name="area" value="{{ old('area') }}" required autofocus>
                                    @foreach($Area as $area)
                                        <option @if($cargo->id_area == $area->id_area) selected @endif value = "{{ $area->id_area }}">
                                            {{ $area->nome }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cargo" type="text" class="form-control " name="nome" value="{{ $cargo->nome }}" required autofocus>
                            </div>
                        </div>
