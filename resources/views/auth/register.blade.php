                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('cadastrar_usuario') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cep" type="number" min = "1" class="form-control" name="cep" required>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="numero" type="number" min = "1" class="form-control" name="numero" value="{{ old('numero') }}" required>
                            </div>
                        </div>
